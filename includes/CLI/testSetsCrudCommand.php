...
if (defined('WP_CLI') && WP_CLI) {
    WP_CLI::add_command('wpfn test:sets', function ($args, $assoc_args) {
        ...
        try {
            ...
            $results['upsert_insert'] = ['id' => $insert_id_2];

            // 7) LIST BY USER
            $list = $repo->list_by_user($user_id, 50, 0);
            $results['list_by_user'] = [
                'count'    => count($list),
