	...
	WP_CLI::add_command(
		...
		function () {
			...
			try {
				...
				global $wpdb;
				$required = array( 'wpfn_cards', 'wpfn_sets', 'wpfn_card_set_relations' );
				$ran      = array();
				...
				$results['ensure_tables'] = array( 'ran' => $ran );
				...
				$results['attach'] = array( 'first_two_attached' => 1 );
