...
abstract class BaseRepository
{
   ...
   public function insert(array $data): int
    ...
    {
        $id     = $this->validate_id($id);
        $result = $this->wpdb->delete($this->get_table_name(), ['id' => $id], ['%d']);
     ...
     */
    public function find(array $where = [], ?int $limit = null, ?int $offset = null): array
    {
        $table = $this->get_table_name();
        ...
        return $this->wpdb->get_results($this->wpdb->prepare($sql, ...$values), ARRAY_A) ?: [];
    }
